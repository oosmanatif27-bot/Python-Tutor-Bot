...
lessons_py = {
    "1": {"title": "الدرس 1: الطباعة (print) 🐍", "explanation": "دالة print هي أول خطوة لتعلم أي لغة برمجة، ووظيفتها عرض النصوص والنتائج.", "example": "print('مرحباً بك')", "exercise": "اطبع اسمك الثلاثي.", "solution": "print('عثمان ...')"},
